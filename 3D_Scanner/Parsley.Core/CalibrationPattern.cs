...
namespace Parsley.Core {
  ...
  public abstract class CalibrationPattern 
  {
    ...
    public CalibrationPattern() {} //empty constructor
    ...
    public bool FindPattern(Emgu.CV.Image<Gray, byte> img) //cari pola yang digunakan saat kalibrasi intrinsik, tanpa dibatasi ROI
    {
