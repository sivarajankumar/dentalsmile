...
namespace smileUp.Views
{
    ...
    public class SmileFileFilter
    {
        ...
        public bool Matches(int text)
        {
            return (this.filterText != null && text != null &&
                this.filterText.Contains((""+text).ToLower(CultureInfo.CurrentCulture)));
        }
        /// <summary>
    ...
    /// ??
    /// </summary>
    public class FileFilterSortListView : SortListView
    {
        private delegate void FilterDelegate();
        private SmileFileFilter filter = new SmileFileFilter();

        /// <summary>
        /// Get the filter for this control.
        /// </summary>
        protected SmileFileFilter Filter
        {
