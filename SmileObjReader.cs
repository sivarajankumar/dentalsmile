...
namespace smileUp
{
    ...
    using HelixToolkit.Wpf;
        ...
        public class SmileObjReader 
        {
            ...
            /// The model.
            /// </returns>
            public ModelVisual3D Read(string path)
            {
            ...
            /// The model.
            /// </returns>
            public ModelVisual3D Read(Stream s)
            {
            ...
            /// </remarks>
            public ModelVisual3D ReadZ(string path)
            {
                this.TexturePath = Path.GetDirectoryName(path);
                using (var s = new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
            ...
            /// </remarks>
            public void AddFace(string values)
            {
            ...
            /// The input values.
            /// </param>
            public void AddVertex(string values)
            {
                var fields = Split(values);
            ...
            /// A Model3D object.
            /// </returns>
            public Model3DGroup BuildModel()
            {
