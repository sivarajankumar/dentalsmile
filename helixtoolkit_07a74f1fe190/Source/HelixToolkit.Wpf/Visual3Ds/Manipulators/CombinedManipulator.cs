...
namespace HelixToolkit.Wpf
{
    ...
    public class CombinedManipulator : ModelVisual3D
    {
        ...
        public static readonly DependencyProperty LengthProperty = DependencyProperty.Register(
            "Length", typeof(double), typeof(CombinedManipulator), new UIPropertyMetadata(2.0, LengthChanged));
        ...
        public CombinedManipulator()
        {
            ...
            BindingOperations.SetBinding(
               this.translateXManipulator,
               TranslateManipulator.LengthProperty,
               new Binding("Length") { Source = this });
            BindingOperations.SetBinding(
                this.translateYManipulator,
                TranslateManipulator.LengthProperty,
               new Binding("Length") { Source = this });
        ...
        {
            ((CombinedManipulator)d).OnLengthChanged();
        }
